<template>
  <div class="container">
      ...
      <div class="article-block-text">
        <h1 class="one-title">Политика конфиденциальности</h1>

        <h2 class="advantages_title">1. Общие положения</h2>
        <p>
          ...
          "Доступный город" (далее – Оператор). Оператор ставит своей важнейшей
        ...
        <h2 class="advantages_title">2. Основные понятия, используемые в Политике</h2>
        <p>
          Автоматизированная обработка персональных данных – обработка
          персональных данных с помощью средств вычислительной техники;
          Блокирование персональных данных – временное прекращение обработки
          персональных данных (за исключением случаев, если обработка необходима
          для уточнения персональных данных); Веб-сайт – совокупность
          ...
          адресу http://paytaxi.ru; Информационная система персональных данных —
          ...
          средств; Обезличивание персональных данных — действия, в результате
          ...
          или иному субъекту персональных данных; Обработка персональных данных
          ...
          действия (операции), совершаемые с персональными данными; Персональные
          данные – любая информация, относящаяся прямо или косвенно к
          определенному или определяемому Пользователю веб-сайта
          http://paytaxi.ru; Пользователь – любой посетитель веб-сайта
          http://paytaxi.ru или пользователь мобильного приложения PayTaxi;
        ...
        <p>
          Пользователя Фамилия, имя, отчество; Электронный адрес; Номера
          телефонов; Банковские реквизиты; Также на сайте происходит сбор и
          ...
          и других). Вышеперечисленные данные далее по тексту Политики
          объединены общим понятием Персональные данные.
        </p>
        <h2 class="advantages_title">4.Цели обработки персональных данных</h2>
        <p>
          ...
          содержащимся на вебсайте и в мобильном приложении PayTaxi. Также
          ...
          info@paytaxi.ru с пометкой «Отказ от уведомлениях о новых продуктах и
          услугах и специальных предложениях». Обезличенные данные
          Пользователей, собираемые с помощью сервисов интернетстатистики,
        ...
        <p>
          ...
          специальные формы, расположенные на сайте http://paytaxi.ru, а также в
          мобильном приложении PayTaxi. Заполняя соответствующие формы и/или
        ...
        <p>
          ...
          случаев, связанных с исполнением действующего законодательства. В
          ...
          уведомление на адрес электронной почты Оператора info@paytaxi.ru с
          ...
          электронный адрес Оператора info@paytaxi.ru с пометкой «Отзыв согласия
          на обработку персональных данных».
        </p>
        <h2 class="advantages_title">7.Трансграничная передача персональных данных</h2>
        <p>
          ...
          данных. Трансграничная передача персональных данных на территории
        ...
        <h2 class="advantages_title">8.Заключительные положения</h2>
        <p>
          ...
          Оператору с помощью электронной почты info@paytaxi.ru. В данном
          ...
          расположена в сети Интернет по адресу http://paytaxi.ru/policy.
        </p>
      </div>
    </div>
